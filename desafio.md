# CONFIDENCIAL Front-End Engineer Challenge
...
**1.- Você recebeu uma atividade para adicionar uma funcionalidade em uma página SPA React simples que lista uma coleção de itens (os produtos transacionais da CONFIDENCIAL). Sua tarefa é implementar a seguinte funcionalidade:**
...
***Nota: Você pode utilizar o scaffold disponibilizado no diretório "CONFIDENCIAL-react-app" ou sugerir uma estrutura mais adequada. O que achar melhor.***  
...
**3.- Nossos analistas de qualidade reportaram uma falha na página de listagem de produtos CONFIDENCIAL. Um card reportando o bug foi atribuído à você com a ***Stack Trace*** a seguir.**
...
Este serviço gera um token de acesso para utilizar às APIs transacionais da CONFIDENCIAL.
